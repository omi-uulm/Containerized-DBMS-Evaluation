...
IPS[host_name3]="10.1.1.14" # dockered version with attached volume
...
function loadWorkload {
    cd ~/ycsb-0.12.0
    ./bin/ycsb load mongodb -s -threads $1 -P workloads/workloada -p recordcount=2000000 -p operationcount=10000000 -threads 8 -p mongodb.url="mongodb://${2}:27017/ycsb?w=1" > $HOME/${3}/load.txt 2>&1
}
...
function runWorkloadA {
    cd ~/ycsb-0.12.0
    ./bin/ycsb run mongodb -s -threads $1 -P workloads/workloada -p recordcount=2000000 -p operationcount=10000000 -threads 8 -p mongodb.url="mongodb://${2}:27017/ycsb?w=1" > $HOME/${3}/run_workloadA.txt 2>&1
}
...
function runWorkloadB {
    cd ~/ycsb-0.12.0
    ./bin/ycsb run mongodb -s -threads $1 -P workloads/workloadb -p recordcount=2000000 -p operationcount=10000000 -threads 8 -p mongodb.url="mongodb://${2}:27017/ycsb?w=1" > $HOME/${3}/run_workloadB.txt 2>&1
}
